...
\begin{frame}{On to the practical exercise...}
  ...
  \item There are a lot more (and more sophisticated) techniques that leverage probabilistic programming, so I strongly encourage anyone to explore edwardlib.org for more examples.
  \item The focus here was on NN because that's what we've been talking about, and I kept it simple because this is all new for me.
  \end{itemize}
\end{frame}
